...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <li class="nav-item dropdown">
        <a class="nav-link" href="reservation-list" aria-expanded="false">
                  ...
                  <div class="row">
					...
					<div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <form:input type="text" class="form-control" placeholder="Enter recipe name" path="recipe.name"/>
                      <form:errors path="recipe.name" cssClass="text-danger"/>
                      </div>
                      <div class="form-group">
                        <label>Recipe description</label>
                        <form:textarea class="form-control" placeholder="Enter recipe description" path="recipe.description"/>
                       <form:errors path="recipe.description" cssClass="text-danger"/>
                      </div>
						 
                      <div class="form-group">
                        <label>Tags</label>
                        <form:select path="tags" itemLabel="name" itemValue="id" items="${tagList}" multiplue="true" class="form-control"/>                                                 
                      </div>
