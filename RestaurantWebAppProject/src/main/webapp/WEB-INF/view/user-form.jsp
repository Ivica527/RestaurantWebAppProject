                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <form:input type="text" class="form-control" placeholder="Enter password" path="password"/>
                        <form:errors path="password" cssClass="text-danger"/>
                      </div>
                      
                      <div class="form-group">
                        <label>Roles</label>
                        <form:select path="authorities" items="${roles}" itemLabel="authority" itemValue="authority" multiplue="true" class="form-control"/>                                                 
                      </div> 
